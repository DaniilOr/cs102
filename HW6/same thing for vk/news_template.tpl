...
<html>
    ...
    <body>
        ...
        <center>  <a href="/classify" class="ui right floated small primary button">Sort posts!</a> </center>
            <thead>
                <th>Text</th>
                <th>#Likes</th>
                <th>#Views</th>
            ...
            <tfoot class="full-width">
                <tr>
                    <th colspan="7">
                        <a href="/update" class="ui right floated small primary button">Gimme more posts!</a>
                    </th>
                </tr>
            </tfoot>
        </table>
